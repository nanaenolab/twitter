...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "WvbcE01SH8ppWhh3FpGiaHqDE", consumerSecret: "OgiTwXTrbhf4Dk3yg9rSCQkx1mg0qzs1ZGpJXguEQ19Rx80OtD")
    var loginSuccess: (() -> ())?
